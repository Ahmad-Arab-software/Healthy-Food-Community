      ...
      <p class="text-gray-600">
        ...
        if (isset($_SESSION['email'])) {
          ...
          if ($row = mysqli_fetch_array($query)) {
            echo "Hallo, " . htmlspecialchars($row['firstName']) . ' ' . htmlspecialchars($row['lastName']) . "!";
          } else {
      ...
      <div id="collapseMenu"
        ...
        <ul
          ...
          <li class='max-lg:border-b max-lg:py-3'><a href='./YourRecepie.php'
              class='hover:text-[#178a0e] text-gray-600 font-bold text-[15px] block'>Your Recipes</a></li>
        </ul>
      </div>
  ...
  <div class="container mx-auto p-6 pt-32">
    ...
    <section class="container mx-auto p-6">
      <div id="breakfast-recipes" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        <!-- Breakfast Recipe Cards will be inserted here -->
      </div>
    </section>
    ...
    <section class="container mx-auto p-6">
      <div id="lunch-recipes" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        <!-- Lunch Recipe Cards will be inserted here -->
      </div>
    </section>
    ...
    <section id="recipe-details-popup"
      class="z-10 fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center hidden">
      <div
